...
public class WorkmatesListRestaurantDetailsAdapter extends RecyclerView.Adapter {
    //For Data
    ...
    public WorkmatesListRestaurantDetailsAdapter(List<User> users, RequestManager glide, Activity activity) {
        this.users = users;
        this.glide = glide;
    ...
    static class WorkmatesListRestaurantViewHolder extends RecyclerView.ViewHolder {
       ...
       // private Activity activity;
        ...
        private void updateWorkmates(User user, RequestManager glide) {
            ...
            String message = itemText.getContext().getString(R.string.list_workmates_adapter_is_joining, user.getName())
            ;
